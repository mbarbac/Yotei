...
public partial class ElementList_KT : IHost
{
    ...
    public ElementList_KT(bool ignoreCase) => IgnoreCase = ignoreCase;
    ...
    public ElementList_KT(bool ignoreCase, IEnumerable<IItem> range)
        : this(ignoreCase)
    ...
    protected ElementList_KT(THost other)
    {
