...
// ========================================================
/// <summary>
/// Decorates classes for which 'InvariantList[K, T]' will be used as their base one, and its
...
{
    /// <summary>
    /// The type of the keys of the 'InvariantList[K, T]' decorated collection.
    /// </summary>
