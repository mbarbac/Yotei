...
// ========================================================
/// <summary>
/// Decorates interface types for which either 'IInvariantList[T]' or 'IInvariantList[K,T]' will
/// be implemented. The inherited methods will be upcasted to the decorated host type, unless
