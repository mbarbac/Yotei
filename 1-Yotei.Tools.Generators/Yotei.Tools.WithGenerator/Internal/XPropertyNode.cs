...
internal class XPropertyNode : PropertyNode
{
    ...
    {
        if (Host.Name == "AbstractFromAbstract" && Symbol.Name == "Branch") { } // DEBUG ONLY
    ...
    /// <param name="ifaces"></param>
    /// <returns></returns>
    public AttributeData? FindWithAttribute(ITypeSymbol type, bool chain = false, bool ifaces = false)
    {
