...
/// <inheritdoc/>
/// </summary>
internal class XField : FieldNode
{
    /// <summary>
    /// <inheritdoc/>
    /// </summary>
    /// <param name="candidate"></param>
    public XField(FieldCandidate candidate) : base(candidate) { }

    /// <summary>
    /// <inheritdoc/>
    /// </summary>
    /// <param name="symbol"></param>
    public XField(IFieldSymbol symbol) : base(symbol) { }
    ...
    public override bool Validate(SourceProductionContext context)
    {
        ...
        if (!context.TypeIsNotRecord(type)) return false;

        if (!context.FieldIsWrittable(Symbol)) return false;
