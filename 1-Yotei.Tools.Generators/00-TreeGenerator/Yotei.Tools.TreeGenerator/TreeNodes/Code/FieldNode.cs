...
public partial class FieldNode : IChildNode
{
    ...
    /// <returns></returns>
    public virtual FieldNode With(
        BaseFieldDeclarationSyntax syntax, IEnumerable<AttributeData> attributes, SemanticModel model)
    {
    ...
    ITreeNode ITreeNode.With(
        ...
        => With((BaseFieldDeclarationSyntax)syntax, attributes, model);
