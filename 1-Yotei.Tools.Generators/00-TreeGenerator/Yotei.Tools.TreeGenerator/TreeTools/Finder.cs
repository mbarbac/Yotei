...
public static class Finder
{
    ...
    /// the first one in the given collection of type chains that match the given predicate, in
    /// order. If found, returns true (and sets the value of the out argument). Otherwise, returns
    /// false.
    /// </summary>
    /// <typeparam name="T"></typeparam>
