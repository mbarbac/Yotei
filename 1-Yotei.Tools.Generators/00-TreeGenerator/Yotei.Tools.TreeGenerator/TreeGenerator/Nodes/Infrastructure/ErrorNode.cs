...
public sealed class ErrorNode : INode
{
    ...
    /// <summary>
    /// The collection of diagnostics carried by this instance.
    /// </summary>
    public List<Diagnostic> Diagnostics { get; } = [];

    /// <summary>
    /// Reports into the given context the diagnostics carried by this instance.
    /// </summary>
    /// <param name="context"></param>
    public void Report(
        SourceProductionContext context) => Diagnostics.ForEach(x => x.Report(context));
