...
// ========================================================
/// <summary>
/// Represents an error node that produces no code, but instead carries error diagnostics that
/// will be reported at souce code generation time.
/// </summary>
public sealed class ErrorNode : INode
{
    ...
    /// <summary>
    /// Reports into the given context all the diagnostics collected in this instance.
    /// </summary>
    /// <param name="context"></param>
    public void Report(SourceProductionContext context)
    {
        foreach (var diag in Diagnostics) diag.Report(context);
    }
