...
partial class TypeNode
{
    ...
    /// </summary>
    int OnEmitParents(SourceProductionContext context, CodeBuilder cb)
    {
        ...
        return SyntaxNodes.Count == 0
            ? OnEmitParentsFromSymbol(context, cb)
            : OnEmitParentsFromSyntaxNodes(context, cb);
    }
    ...
    /// </summary>
    int OnEmitParentsFromSymbol(SourceProductionContext context, CodeBuilder cb)
    {
    ...
    /// the richest way.
    /// </summary>
    int OnEmitParentsFromSyntaxNodes(SourceProductionContext context, CodeBuilder cb)
    {
        List<string> pragmas = [];
        List<string> usings = [];
