...
{
    // ----------------------------------------------------
    // int IndexOf(StringSpan span)
    // int IndexOf(StringSpan span, StringComparison comparison)
    ...
    // ----------------------------------------------------
    // int LastIndexOf(StringSpan)
    // int LastIndexOf(StringSpan, StringComparison)
    ...
    /// <returns></returns>
    public static StringSpan Remove(
        this StringSpan source, StringSpan value) => Remove(source, value, out _);
        ...
        this StringSpan source, StringSpan value, StringComparison comparison, out bool removed)
    {
        ...
        var index = source.ToString().LastIndexOf(value.ToString(), comparison); // Hack!
        if (index < 0) return source;
