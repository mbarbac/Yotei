...
{
    /// <summary>
    /// Returns the chain of namespace declaration syntax elements to the given node, including
    /// itself if it is a namespace declaration.
    /// </summary>
    ...
    /// <summary>
    /// Returns the chain of type declaration syntax elements to the given node, including
    /// itself if it is a type declaration.
    /// </summary>
    /// <param name="node"></param>
    /// <returns></returns>
