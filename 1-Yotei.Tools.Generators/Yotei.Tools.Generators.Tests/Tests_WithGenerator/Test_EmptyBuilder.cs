// Empty Builder scenario:
// Parameterless constructor forced. Either do not use any init/set optional argument to, by
// default, used them all, or explicitly enforced '+*' or '+@' to use the enforced element.
...
namespace Yotei.Tools.WithGenerator.Tests
{
    ...
    public static class Test_EmptyBuilder
    {
        ...
        public static void Test_Interface()
        {
            ...
            Assert.Equal("Manager.Empty", ((Other.Manager)target)._Info);
        }
        ...
        public static void Test_Concrete()
        {
            ...
            Assert.Equal(source.Branch, target.Branch);
            Assert.Equal("Manager.Empty", target._Info);
