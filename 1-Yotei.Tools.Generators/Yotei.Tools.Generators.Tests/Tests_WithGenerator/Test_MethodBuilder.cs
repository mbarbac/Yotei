// Concrete Method scenario:
// Selects the method(s) whose name is given.
// If any property is init-only, then a compile-error will be produced.
...
namespace Yotei.Tools.WithGenerator.Tests
{
    ...
    public static class Test_MethodBuilder
    {
        ...
        public static void Test_Interface()
        {
            ...
            Assert.Equal("Manager.Creator", ((Other.Manager)target)._Info);
        }
        ...
        public static void Test_Concrete()
        {
            ...
            Assert.Equal(source.Branch, target.Branch);
            Assert.Equal("Manager.Creator", target._Info);
