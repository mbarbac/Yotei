// Copy Builder scenario:
// Because the unique argument specified matches the type being built, it is understood as a
// copy constructor. We don't need to specify or remove init/set members, as they are all used.
