...
// ========================================================
//[Enforced]
public static partial class Test_HostAbstract
{
    // EasyCase...
    ...
    partial interface IFace13 { [With(ReturnType = typeof(IFace13))] string? Name { get; } }
    ...
    [InheritsWith(ReturnType = typeof(IFace14))]
    abstract partial class AType14 : IFace14
    {
        public string? Name { get; set; }
        [With(ReturnType = typeof(IFace14))] public int Age;
    }
    ...
    [InheritsWith]
    abstract partial class AType22B : AType22A, IFace22B
    {
        //public abstract override AType22B WithAge(int value);
    }
    ...
    [InheritsWith(ReturnType = typeof(IFace24A))]
    abstract partial class AType24A : IFace24A
    {
        public string? Name { get; set; }
        [With(ReturnType = typeof(IFace24A))] public int Age;
    }
    ...
    [InheritsWith(ReturnType = typeof(IFace25A))]
    abstract partial class AType25A : IFace25A
    {
        public string? Name { get; set; }
        [With(ReturnType = typeof(IFace25A))] public int Age;
    }

    [InheritsWith(ReturnType = typeof(IFace25B))]
    abstract partial class AType25B : AType25A, IFace25B { }
    ...
    abstract partial class AType30A<T> : IFace30A<T>
    {
        ...
        [With(ReturnType = typeof(IFace30A<>))] public T Age = default!;
    }
