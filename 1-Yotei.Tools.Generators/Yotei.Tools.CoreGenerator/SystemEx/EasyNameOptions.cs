...
internal record EasyNameOptions
{
    ...
    /// <summary>
    /// Whether to use the nullable '?' annotation with the type if needed.
    /// <br/> This setting is only applied to <see cref="ITypeSymbol"/> Roslyn elements, not to
    /// regular C# ones.
    /// </summary>
    ...
    /// <br/> Note that '$' is ignored for Roslyn elements.
    /// </summary>
    ...
    private EasyNameOptions(BuildMode mode)
    {
        ...
        switch (mode)
        {
            ...
            case BuildMode.Default:
                ...
                TypeUseNullable = true; // Use the nullable annotation if any
