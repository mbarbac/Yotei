...
internal static partial class RoslynNameExtensions
{
    ...
    public static string EasyName(
        this TypedConstant source) => RoslynNameTypedConstantOptions.Default.EasyName(source);
    ...
    /// <returns></returns>
    public static string EasyName(this TypedConstant source, RoslynNameTypedConstantOptions options)
    {
...
/// </summary>
internal record RoslynNameTypedConstantOptions
{
    /// <summary>
    /// A shared read-only instance that represents empty options.
    /// </summary>
    public static RoslynNameTypedConstantOptions Empty { get; } = new(Mode.Empty);

    /// <summary>
    /// A shared read-only instance that represents default options.
    /// </summary>
    public static RoslynNameTypedConstantOptions Default { get; } = new(Mode.Default);

    /// <summary>
    /// A shared read-only instance that represents full options.
    /// </summary>
    public static RoslynNameTypedConstantOptions Full { get; } = new(Mode.Full);

    /// <summary>
    /// Initializes a new default instance.
    /// </summary>
    public RoslynNameTypedConstantOptions() : this(Mode.Default) { }
    ...
    private RoslynNameTypedConstantOptions(Mode mode)
    {
        switch (mode)
        {
            case Mode.Empty:
