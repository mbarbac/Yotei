...
internal class TypeNode : INode
{
    ...
    public class PropertyChildrenList : ChildrenList<PropertyNode>
    {
        ...
        protected override string ItemToString(PropertyNode item) => item.Symbol.Name;
    }
    ...
    public class FieldChildrenList : ChildrenList<FieldNode>
    {
        ...
        protected override string ItemToString(FieldNode item) => item.Symbol.Name;
    }
    ...
    public class MethodChildrenList : ChildrenList<MethodNode>
    {
        ...
        protected override string ItemToString(MethodNode item) => item.Symbol.Name;
    }
