...
internal record EasyNameOptions
{
    ...
    /// </summary>
    /// <param name="useFullName">True to obtain the fully-qualified name of the symbol, instead of its short one.</param>
    /// <param name="addNullable">True to add to the symbol type its nullable annotation, if any.</param>
    /// <param name="useGenerics">True to use the generic type arguments of the symbol.</param>
    /// <param name="useHostType">True to preceed the member name with the host type and a dot.</param>
    /// <param name="useMemberType">True to use either the return type of the member, or the member type.</param>
    /// <param name="useMemberArguments">True to use either the method arguments or the indexer parameters.</param>
