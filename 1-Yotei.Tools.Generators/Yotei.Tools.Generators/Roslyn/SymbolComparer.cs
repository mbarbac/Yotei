...
// ========================================================
/// <summary>
/// Comparers two <see cref="ISymbol"/> instances using the given options, provided that the
/// kind of the given symbols is <see cref="INamespaceSymbol"/>, <see cref="INamedTypeSymbol"/>,
/// <see cref="IMethodSymbol"/>, <see cref="IPropertySymbol"/>, or <see cref="IFieldSymbol"/>.
/// <br/> Otherwise reverts to the <see cref="SymbolEqualityComparer"/>
/// behavior.
/// </summary>
internal record SymbolComparer : IEqualityComparer<ISymbol?>
{
    ...
    /// <summary>
    /// A shared instance with its settings set to default values, which are <c>true</c> except
    /// <see cref="UseNullability"/> and <see cref="UseMemberType"/>.
    /// </summary>
    /// <remarks>This collection of default settings resembles the standard comparison procedure
    /// where nullability and return types are not taken into consideration - the later to allow
    /// covariant return types for methods and/or properties and fields.</remarks>
    ...
    /// <summary>
    /// Invoked to compare two <see cref="INamespaceSymbol"/> elements.
    /// </summary>
    ...
    /// <summary>
    /// Invoked to compare two <see cref="INamedTypeSymbol"/> elements.
    /// </summary>
    ...
    /// <summary>
    /// Invoked to compare two <see cref="IMethodSymbol"/> elements.
    /// </summary>
    ...
    /// <summary>
    /// Invoked to compare two <see cref="IPropertySymbol"/> elements.
    /// </summary>
    ...
    /// <summary>
    /// Invoked to compare two <see cref="IFieldSymbol"/> elements.
    /// </summary>
