...
// ========================================================
/// <summary>
/// Represents a <see cref="StringBuilder"/>-alike class used to hold source code until it is
/// persisted to disk.
/// </summary>
internal sealed class CodeBuilder
{
    ...
    /// <summary>
    /// Tokenizes the given message into regular parts and new line ones, keeping the later for
    /// further processing.
    /// </summary>
    /// <param name="message"></param>
    /// <param name="count"></param>
    /// <returns></returns>
    static string[] TokenizeNL(string message, int count)
    {
        var list = new List<string>((count * 2) + 1);
