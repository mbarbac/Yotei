...
internal abstract class BaseGenerator : IIncrementalGenerator
{
    ...
    static void PrintHeader(FileBuilder file)
    {
    ...
    /// </summary>
    /// <param name="file"></param>
    static void PrintPragmas(FileBuilder file)
    {
    ...
    /// </summary>
    /// <param name="file"></param>
    static void PrintUsings(FileBuilder file)
    {
        var list = new CustomList<string>()
        {
            AcceptDuplicate = (x, y) => false,
    ...
    /// </summary>
    static void PrintUsings(FileBuilder file, BaseNamespaceDeclarationSyntax ns)
    {
        var list = new CustomList<string>()
        {
            AcceptDuplicate = (x, y) => false,
    ...
    /// </summary>
    static string GetTypeKind(ITypeSymbol symbol) => symbol.TypeKind switch
    {
