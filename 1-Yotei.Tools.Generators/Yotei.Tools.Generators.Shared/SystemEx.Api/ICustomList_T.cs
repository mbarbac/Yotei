...
internal interface ICustomList<T> : IList<T>, IList, ICollection<T>, ICollection, IEnumerable<T>
{
    /// <summary>
    ...
    /// <summary>
    /// Removes from this collection the first ocurrence of the given element, base upon the
    /// equality rules implemented by this instance. Returns the number of changes made, or cero
    /// if any.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection the last ocurrence of the given element, base upon the
    /// equality rules implemented by this instance. Returns the number of changes made, or cero
    /// if any.
    /// </summary>
    /// <param name="item"></param>
    ...
    /// <summary>
    /// Removes from this collection all the ocurrences of the given element, base upon the
    /// equality rules implemented by this instance. Returns the number of changes made, or cero
    /// if any.
    /// </summary>
    /// <param name="item"></param>
