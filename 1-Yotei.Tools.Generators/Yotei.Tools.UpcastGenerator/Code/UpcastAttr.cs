...
internal static class UpcastAttr
{
    ...
    public static string Code(string nsName) => $$"""
        ...
        {
            /// <summary>
            /// Decorates types for which upcasting the relevant elements of a base type or an
            /// inherited interface is requested. Types to upcast must appear in the inheritance
            /// chain of the decorated syntax node and, if needed, identified by their index as
            /// specified in the appropriate constructor.
            /// </summary>
            [AttributeUsage(
            ...
            internal class {{LongName}} : Attribute
            {
                ...
                /// <summary>
                /// Upcasts the relevant elements of the base class and interfaces whose
                /// zero-based indexes in the associated inheritance list are given.
                /// </summary>
                ...
                /// fully support covariant overriden properties (unless they are read-only,
                /// which is not a supported case).
                /// </summary>
