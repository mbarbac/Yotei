...
internal class Program
{
    ...
    static ElementList Includes { get; } = new();
    static ElementList Excludes { get; } = new();
    static AssemblyHolderList AssemblyHolders { get; } = new();
    ...
    /// <param name="ts"></param>
    static void PrintResults(int num, TimeSpan ts)
    {
        WriteLine(Color.Green, Header);
    ...
    /// Executes the tests.
    /// </summary>
    static void Execute(bool breakOnError)
    {
        WriteLine(Color.Green, Header);
        WriteLine(Color.Green, "Executes tests.");
        WriteLine(Color.Green, Header);
    ...
    /// <returns></returns>
    static TimeSpan Execute(bool breakOnError, object? host, MethodInfo method)
    {
    ...
    /// </summary>
    static void PopulateFromRoot()
    {
        var root = AppContext.BaseDirectory;
        WriteLine();
        Write(Color.Magenta, $"> Populating from: {root}...");
    ...
    /// </summary>
    static void PopulateFromIncludes()
    {
        WriteLine();
        Write(Color.Magenta, "> Populating explicit includes...");
    ...
    /// </summary>
    static void PurgeExcludes()
    {
        WriteLine();
        Write(Color.Magenta, "> Purging explicit excludes...");
    ...
    static void PurgeEmpties(AssemblyHolder assemblyHolder)
    {
    ...
    /// </summary>
    static void EnsureEnforced()
    {
        WriteLine();
        Write(Color.Magenta, "> Ensuring enforced elements...");
    ...
    /// </summary>
    static void EnsureEnforcedTypes()
    {
    ...
    /// </summary>
    static void EnsureEnforcedMethods()
    {
    ...
    /// </summary>
    /// <returns></returns>
    static bool AreEnforcedMethods()
    {
        foreach (var assemblyHolder in AssemblyHolders)
    ...
    /// <param name="assemblyHolder"></param>
    /// <returns></returns>
    static bool AreEnforcedMethods(AssemblyHolder assemblyHolder)
    {
        foreach (var typeHolder in assemblyHolder.TypeHolders)
    ...
    /// <returns></returns>
    static bool AreEnforcedMethods(TypeHolder typeHolder)
    {
