...
public static class Test_Method
{
    //[Enforced]
    [Fact]
    public static void Parse_No_Arguments() => Repeater.Repeat(() =>
    {
    ...
    //[Enforced]
    [Fact]
    public static void Parse_Chained_No_Arguments() => Repeater.Repeat(() =>
    {
        Func<dynamic, object> func;
        LambdaNode node;
        LambdaNodeMethod item;
    ...
    //[Enforced]
    [Fact]
    public static void Parse_With_Arguments() => Repeater.Repeat(() =>
    {
        Func<dynamic, object> func;
        LambdaNode node;
        LambdaNodeMethod item;
    ...
    //[Enforced]
    [Fact]
    public static void Parse_Typed() => Repeater.Repeat(() =>
    {
        Func<dynamic, object> func;
        LambdaNode node;
        LambdaNodeMethod item;
    ...
    //[Enforced]
    [Fact]
    public static void Parse_Method_IxSetter() => Repeater.Repeat(() =>
    {
        Func<dynamic, object> func;
        LambdaNode node;
        LambdaNodeMethod item;
