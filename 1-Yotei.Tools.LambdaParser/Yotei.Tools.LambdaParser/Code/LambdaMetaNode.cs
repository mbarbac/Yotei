...
internal class LambdaMetaNode : DynamicMetaObject
{
        ...
        UnaryOperationBinder binder)
    {
        ...
        // Parsing artifacts. The object returned shall be 'false' to prevent the DLR engine
        // to throw a 'type not compatible exception', and to keep the ball rolling...
    ...
    public override DynamicMetaObject BindConvert(ConvertBinder binder)
    {
        ...
        var ret = LambdaParser.GetCompatible(binder.ReturnType, LambdaNode, parser, node);
