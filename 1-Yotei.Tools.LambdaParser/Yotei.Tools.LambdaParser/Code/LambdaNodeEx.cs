...
// ========================================================
public partial class LambdaNode : DynamicObject
{
    /// <summary>
    ...
    /// <summary>
    /// Invoked inheritors when the initialization of this instance has finished to mark it
    /// as completely initialized.
    /// </summary>
    [Conditional("DEBUG")]
