...
public partial interface IFrozenList<K, T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// Returns a new instance with the first element with the given key removed. If no changes
    /// are detected, returns the original instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with the last element with the given key removed. If no changes
    /// are detected, returns the original instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with all the elements with the given key removed. If no changes
    /// are detected, returns the original instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
