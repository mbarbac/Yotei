/*using T = Yotei.Tools.Tests.Test_FrozenList_KT.Element;
using K = string;
...
public static partial class Test_FrozenList_KT
{
    ...
    [Cloneable]
    internal partial class ChainBuilder : CoreList<K, T>
    {
        ...
        public ChainBuilder(Chain master)
        {
            ...
            CompareKeys = (x, y) => string.Compare(x, y, !Master.CaseSensitive) == 0;
