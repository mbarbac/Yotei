/*namespace Yotei.Tools.Tests.Generated;
...
public static partial class Test_Frozen_KT
{
    ...
    [Cloneable]
    public partial class Builder : CoreList<string, Element>
    {
        ...
        public IChain ToInstance() =>
            Count == 0 ? new Chain(Sensitive) :
            Count == 1 ? new Chain(Sensitive, this[0]) : new Chain(Sensitive, this);
    }

    // ====================================================

    [IFrozenList<string, Element>]
    ...
    public partial class Chain : IChain
    {
        ...
        public bool Equals(IChain? other)
        {
            ...
            for (int i = 0; i < Count; i++)
                if (!Items.CompareKeys(Items[i].Name, other[i].Name)) return false;
