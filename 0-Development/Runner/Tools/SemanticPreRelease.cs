...
/// <para>
/// Pre-release versions are denoted by appending a hypen and then a series of dot separated
/// identifiers, using ASCII alphanumeric characters [0 - 9, A - Z, a - z] only, that MUST NOT
...
/// <br/> Build metadata is separated with a plus sign. If used, it contains a series of dot
/// separated identifiers using ASCII alphanumeric characters [0 - 9, A - Z, a - z] only, that
/// MUST NOT be empty.
...
public record SemanticPreRelease : IComparable<SemanticPreRelease>
{
    ...
    /// <br/> Pre-release versions are denoted by appending a hypen (NOT INCLUDED IN THIS VALUE)
    /// and then a series of dot separated identifiers, using ASCII alphanumeric characters only
    /// [0 - 9, A - Z, a - z], that MUST NOT be empty.
    /// Hyphens are only allowed once as the separator.
    ...
    /// <br/> Build metadata is separated with a plus sign (NOT INCLUDED IN THIS PROPERTY). If
    /// used, it contains a series of dot separated identifiers using ASCII alphanumeric 
    /// haracters [0 - 9, A - Z, a - z] only, that MUST NOT be empty.
    /// </summary>
