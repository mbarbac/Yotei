...
/// <para>
/// Semantic versions takes the form 'X.Y.Z-prerelease', where X is the major version, Y is the
/// minor one, and Z is the patch specification. Each part is a not-negative integer that MUST
/// NOT contain leading zeroes.
/// <br/> Pre-release versions are denoted by appending a hypen and a series of dot separated
