...
public static partial class DB
{
    ...
    public static ImmutableList<EmployeeDTO> Employees
    {
        get
        {
            if (field == null)
            {
                field = [.. _EmployeeShort];
                if (LongEnvironment) field.AddRange(_EmployeeLong);
            }
            return field;
        }
        set;
    ...
    readonly static EmployeeDTO[] _EmployeeShort =
    [
    ...
    readonly static EmployeeDTO[] _EmployeeLong =
