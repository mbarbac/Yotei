...
// ========================================================
/// <summary>
/// Executes the test methods found in the test classes of the projects referenced by this.
/// </summary>
public class RunTester : Runner
{
    ...
    /// <summary>
    /// Prints the Program.MenuSeparator title of this action, ending in a new line.
    /// </summary>
    public override void PrintHead() => WriteLine("Run tests.");
    ...
    {
        WriteLine();
        WriteLine(Color.Green, "Running registered tests...");
