...
public abstract class Transaction : DisposableClass, ITransaction
{
    ...
    /// <summary>
    /// Invoked when starting the transaction.
    /// </summary>
    ...
    /// <summary>
    /// Invoked when commiting the transaction.
    /// </summary>
    ...
    /// <summary>
    /// Invoked when aborting the transaction.
    /// </summary>
    ...
    public async ValueTask AbortAsync()
    {
        ...
        await using var disp = await Locker.LockAsync();
