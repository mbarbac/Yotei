    ...
    public void Register(ICaptured captured, int tpIndex)
    {
        ...
        else
        {
            ...
            else
            {
                switch (level)
                {
                    case CaptureLevel.Property: if (CaptureProperty()) return; break;
                    case CaptureLevel.Field: if (CaptureField()) return; break;
                    case CaptureLevel.PropertyOrField: if (CapturePropertyOrField()) return; break;
                }
