...
{
    /// <summary>
    /// Gets the chain of namespace declaration syntax for the given member syntax.
    /// </summary>
    ...
    /// <summary>
    /// Gets the chain of type declaration syntax for the given member syntax, including itself
    /// by default if it is a type one.
    /// </summary>
    /// <param name="syntax"></param>
    ...
    /// <summary>
    /// Gets the chain of type symbols for the given symbol, including itself by default if it
    /// is a type one.
    /// </summary>
