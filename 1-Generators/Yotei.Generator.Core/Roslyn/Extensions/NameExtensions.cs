namespace Yotei.Generator
{
    ...
    public static class NameExtensions
    {
        ...
        /// <returns></returns>
        public static string ShortName(this Microsoft.CodeAnalysis.CSharp.Syntax.NameSyntax nameSyntax, bool useAlias = false)
        {
        ...
        /// <summary>
        /// Returns the long and multipart name of the given name syntax. If it is an alias one,
        /// then its aliased value is used if requested.
        /// </summary>
        /// <param name="nameSyntax"></param>
        /// <param name="useAlias"></param>
        /// <returns></returns>
        public static string LongName(this Microsoft.CodeAnalysis.CSharp.Syntax.NameSyntax nameSyntax, bool useAlias = false)
        {
            nameSyntax = nameSyntax.ThrowIfNull(nameof(nameSyntax));
