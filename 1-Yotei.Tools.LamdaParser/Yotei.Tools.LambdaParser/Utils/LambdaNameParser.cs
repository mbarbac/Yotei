...
// ========================================================
/// <summary>
/// Parses into dot-separated names the members dynamic lambda expression resolves into.
/// </summary>
public static class LambdaNameParser
{
    /// <summary>
    /// Parses the given dynamic lambda expression into the dot-separated names of the members
    /// that expression resolves into. If all parts are empty ones, then returns an empty string.
    /// </summary>
    ...
    /// <summary>
    /// Parses the given dynamic lambda expression into the dot-separated names of the members
    /// that expression resolves into, and returns in the out argument those parts. If all parts
    /// are empty ones, then returns an empty string, and an empty array of parts.
    /// </summary>
    /// <param name="expression"></param>
    ...
    /// <summary>
    /// Parses the given dynamic lambda expression into the dot-separated names of the members
    /// that expression resolves into, and returns in the out argumentthe name of the dynamic
    /// argument. If all parts are empty ones, then returns an empty string.
    /// </summary>
    /// <param name="expression"></param>
    ...
    /// <summary>
    /// Parses the given dynamic lambda expression into the dot-separated names of the members
    /// that expression resolves into, and returns in the out arguments those parts and the name
    /// of the dynamic argument. If all parts are empty ones, then returns an empty string, and
    /// an empty array of parts.
    /// </summary>
    /// <param name="expression"></param>
    /// <param name="parts"></param>
    /// <param name="arg"></param>
