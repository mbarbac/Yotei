...
public class RecordBuilder
{
    ...
    {
        _Schema = new SchemaBuilder((IEngine)entry.ThrowWhenNull().Identifier.Engine);
        _Values = [];
    ...
    public RecordBuilder(IEnumerable<object?> values, IEnumerable<ISchemaEntry> entries)
    {
        ...
        _Schema = new SchemaBuilder((IEngine)entry.Identifier.Engine);
        _Values = [];
