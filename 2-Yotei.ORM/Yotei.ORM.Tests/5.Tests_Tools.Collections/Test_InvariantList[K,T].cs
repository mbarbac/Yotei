...
// ========================================================
//[Enforced]
public static class Test_InvariantList_KT
{
    ...
    public class Chain : InvariantList<string, IElement>, IElement
    {
    ...
    [DebuggerDisplay("{ToDebugString(5)}")]
    public class Builder : CoreList<string, IElement>, IElement
    {
