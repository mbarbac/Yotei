...
public static class Test_Identifier_Match
{
    ...
    public static void Test_Empty()
    {
        ...
        var source = new Code.Identifier(engine);
        var target = new Code.Identifier(engine);
    ...
    public static void Test_Insensitive()
    {
        ...
        target = new Code.Identifier(engine, "ONE");
        Assert.True(source.Match(target));
        ...
        source = new Code.Identifier(engine, "one.two");
        target = new Code.Identifier(engine, "one.x");
        Assert.False(source.Match(target));

        source = new Code.Identifier(engine, "one.two.three");
        target = new Code.Identifier(engine, "..three");
        Assert.True(source.Match(target));
        ...
        source = new Code.Identifier(engine, "one.two.three");
        target = new Code.Identifier(engine, "two.");
        Assert.True(source.Match(target));
    }
    ...
    public static void Test_Insensitive_Target_Bigger()
    {
        ...
        var source = new Code.Identifier(engine);
        var target = new Code.Identifier(engine, "any");
        Assert.False(source.Match(target));

        source = new Code.Identifier(engine, "one");
        target = new Code.Identifier(engine, "two.one");
        Assert.False(source.Match(target));

        source = new Code.Identifier(engine, "two.one");
        target = new Code.Identifier(engine, "four...one");
        Assert.False(source.Match(target));
    }
    ...
    public static void Test_Sensitive()
    {
        ...
        var source = new Code.Identifier(engine, "one");
        var target = new Code.Identifier(engine, "ONE");
        Assert.False(source.Match(target));
