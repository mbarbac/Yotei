...
public static class Test_ParameterList
{
    ...
    {
        var engine = new FakeEngine();
        var items = new ParameterList(engine, [x007, xJames, x007]);
        ...
        var y007 = new Parameter(x007.Name, x007.Value);
        try { _ = new ParameterList(engine, [x007, xJames, y007]); Assert.Fail(); }
    ...
    public static void Test_Find()
    {
        ...
        Assert.Equal(-1, items.IndexOf("other"));
        ...
        list = items.IndexesOf(x => (x.Value as string) == "007");
        Assert.Equal(2, list.Count);
        Assert.Equal(0, list[0]);
        Assert.Equal(3, list[1]);
    }
    ...
    {
        var engine = new FakeEngine();
        var source = new ParameterList(engine, [x007, xJames, x007]);
    ...
    public static void Test_Replace()
    {
        ...
        try { _ = source.Replace(0, new Parameter("Id", "007")); Assert.Fail(); }
        catch (DuplicateException) { }
    }
    ...
    public static void Test_AddRange()
    {
        ...
        try { _ = source.AddRange([xBond, null!]); Assert.Fail(); }
        catch (ArgumentNullException) { }

        try { _ = source.AddRange([xBond, new Parameter(x007.Name, x007.Value)]); Assert.Fail(); }
        catch (DuplicateException) { }
    }
    ...
    public static void Test_Insert()
    {
        ...
        var target = source.Insert(4,xMi6);
        Assert.NotSame(source, target);
        Assert.Equal(5, target.Count);
        Assert.Same(x007, target[0]);
        Assert.Same(xJames, target[1]);
        ...
        try { source.Insert(4,new Parameter("Id", "008")); Assert.Fail(); }
        catch (DuplicateException) { }

        try { source.Insert(4,null!); Assert.Fail(); }
        catch (ArgumentNullException) { }
    }
    ...
    public static void Test_InsertRange()
    {
        ...
        try { _ = source.InsertRange(2,[xBond, null!]); Assert.Fail(); }
        catch (ArgumentNullException) { }

        try { _ = source.InsertRange(2,[xBond, new Parameter(x007.Name, x007.Value)]); Assert.Fail(); }
        catch (DuplicateException) { }
    }
