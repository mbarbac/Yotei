...
public static class Test_SchemaEntry
{
    ...
    public static void Test_Equality()
    {
        ...
        // Curiously, XUnit.Equals fails, it seems it does not recognize IEquatable<interface>...
        // So, we use a boolean XUnit.True instead
    ...
    public static void Test_Add_PrimaryKeyTag()
    {
        ...
        var target = source.Add(new(tag!, false));
        Assert.Same(source, target);
