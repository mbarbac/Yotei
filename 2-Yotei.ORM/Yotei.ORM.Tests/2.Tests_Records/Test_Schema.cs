...
public static class Test_Schema
{
    ...
    public static void Test_Create_Many()
    {
        ...
        try { _ = new Schema(engine, [xid, xfirst, xid]); Assert.Fail(); }
        catch (DuplicateException) { }

        try { _ = new Schema(engine, [xid, new SchemaEntry(engine, "dbo.Employees.Id")]); Assert.Fail(); }
        catch (DuplicateException) { }
    ...
    public static void Test_Add()
    {
        ...
        try { source.Add(new SchemaEntry(engine, xid)); Assert.Fail(); }
        catch (DuplicateException) { }
    ...
    public static void Test_AddRange()
    {
        ...
        try { source.AddRange([new SchemaEntry(engine, "any"), null!]); Assert.Fail(); }
        catch (ArgumentException) { }

        try { source.AddRange([xid]); Assert.Fail(); }
        catch (DuplicateException) { }
    }
    ...
    public static void Test_Insert()
    {
        ...
        try { source.Insert(0, new SchemaEntry(engine, xid)); Assert.Fail(); }
        catch (DuplicateException) { }
    }
    ...
    public static void Test_InsertRange()
    {
        ...
        try { source.InsertRange(0, [new SchemaEntry(engine, "any"), null!]); Assert.Fail(); }
        catch (ArgumentException) { }

        try { source.InsertRange(0, [xid]); Assert.Fail(); }
        catch (DuplicateException) { }
    }
