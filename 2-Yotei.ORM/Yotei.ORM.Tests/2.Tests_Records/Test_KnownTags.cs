...
public static class Test_KnownTags
{
    ...
    public static void Test_With_IdentifierTags()
    {
        ...
        items = new IdentifierTags(engine, new MetadataTag(engine, "SchemaTag"));
        target = source.WithIdentifierTags(items);
        Assert.NotSame(source, target);
        Assert.Same(items, target.IdentifierTags);

        items = new IdentifierTags(engine, new MetadataTag(engine, "PRIMARYTAG"));
    ...
    public static void Test_With_PrimaryKeyTag()
    {
        ...
        var item = new MetadataTag(engine, "any");
        ...
        item = new MetadataTag(engine, "SCHEMATAG");
