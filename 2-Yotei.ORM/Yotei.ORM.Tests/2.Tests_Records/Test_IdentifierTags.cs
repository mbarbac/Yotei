...
public static class Test_IdentifierTags
{
    ...
    public static void Test_Create_Single()
    {
        ...
        try { _ = new Tags(false, [null!]); Assert.Fail(); }
    ...
    public static void Test_Find()
    {
        ...
        index = items.IndexOf(["any", "TWOB", "ONEB"]); Assert.Equal(0, index); // OneB
        index = items.IndexOf(["any", "ONEB", "TWOB"]); Assert.Equal(0, index); // OneB
    }
