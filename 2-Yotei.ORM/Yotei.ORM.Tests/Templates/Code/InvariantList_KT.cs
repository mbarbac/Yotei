...
public partial class InvariantListKT : THost
{
    ...
    public InvariantListKT(IEngine engine) => Engine = engine.ThrowWhenNull();
    ...
    public InvariantListKT(IEngine engine, TItem item) : this(engine) => AddInternal(item);
    ...
    protected InvariantListKT(
        InvariantListKT source) : this(source.Engine) => AddRangeInternal(source);
