...
// Note that StrTokenText is somehow an special case because it itself is also its reduced form.
// So, in the following tests we need to use 'reduce: false' to validate results that, otherwise,
// would have been reduced into combined text ones.

// ========================================================
//[Enforced]
public static class Test_StrTextTokenizer
{
    //[Enforced]
    [Fact]
