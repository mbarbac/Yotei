...
public static class Test_FragmentSetter
{
    //[Enforced]
    [Fact]
    public static void Test_Literal_FromValue()
    {
    ...
    //[Enforced]
    [Fact]
    public static void Test_Literal_FromValue_Rounded()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentSetter.Master master;
        FragmentSetter.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Literal_FromInvoke()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentSetter.Master master;
        FragmentSetter.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Expression_NullValue()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentSetter.Master master;
        FragmentSetter.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Expression_Valued()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentSetter.Master master;
        FragmentSetter.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Expression_Invalid() // Only some examples...
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentSetter.Master master = new(command);

        try { master.Capture(x => x.One.Two); Assert.Fail(); }
        catch (ArgumentException) { }

        try { master.Capture(x => x.One == x.Two); Assert.Fail(); }
        catch (ArgumentException) { }
    }
