...
public static class Test_FragmentWhere
{
    ...
    public static void Test_Literal_String()
    {
        ...
        master = new(command);
        master.Capture(x => " Id = null "); // Accepting '=' for convenience...
    ...
    //[Enforced]
    [Fact]
    public static void Test_Literal_String_Raw_Connector()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentWhere.Master master;
        FragmentWhere.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Literal_Info_Connected()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentWhere.Master master;
        FragmentWhere.Entry entry;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Literal_Many_Concatenated()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentWhere.Master master;
        FragmentWhere.Entry entry;
        ...
        // Note that 2nd entry add spaces because it is a connector-only instance...
        builder = master.Visit();
    ...
    //[Enforced]
    [Fact]
    public static void Test_Dynamic_Null()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentWhere.Master master;
        FragmentWhere.Entry entry;
    ...
    public static void Test_Dynamic_Invalid()
    {
        ...
        // TODO: seems there is an inconsistency here, because we DO accept connector-only
        // instances when parsing literal-alike specs.
        try { master.Capture(x => x.And()); Assert.Fail(); } // No spec...
        catch (ArgumentException) { }
    ...
    //[Enforced]
    [Fact]
    public static void Test_Dynamic_Many_Info()
    {
        var command = new FakeCommand(new FakeConnection(new FakeEngine()));
        FragmentWhere.Master master;
        FragmentWhere.Entry entry;
