...
public partial class ElementList_KT : IHost, IItem
{
    ...
    public ElementList_KT(bool sensitive) => Items = new Builder(sensitive);
    ...
    public ElementList_KT(bool sensitive, IEnumerable<IItem> range) : this(sensitive) => Items.AddRange(range);
