...
public static class Test_Transaction
{
    //[Enforced]
    [Fact]
    public static void Test_Explicit_Creation()
    {
    ...
    //[Enforced]
    [Fact]
    public static void Test_Explicit_Start_Commit()
    {
        var engine = new FakeEngine();
        IConnection connection;
        ITransaction transaction;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Explicit_Start_Abort()
    {
        var engine = new FakeEngine();
        IConnection connection;
        ITransaction transaction;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Explicit_Start_ImplicitAbort()
    {
        var engine = new FakeEngine();
        IConnection connection;
        ITransaction transaction;
    ...
    //[Enforced]
    [Fact]
    public static void Test_Explicit_Start_ConnectionDisposed()
    {
        var engine = new FakeEngine();
        IConnection connection;
        ITransaction transaction;
