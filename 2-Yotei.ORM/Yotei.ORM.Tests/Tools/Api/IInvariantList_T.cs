...
// ========================================================
/// <summary>
/// Represents an immutable list-alike collection of elements that provides custom item validation
/// and duplicates acceptance or denial capabilities.
/// </summary>
[Cloneable]
public partial interface IInvariantListT : IEnumerable<TItem>, IEquatable<THost>
{
    ...
    /// the original collection. If no changes are detected, returns the original instance instead.
    /// </summary>
    /// <param name="index"></param>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance where the elements from the given range has been inserted into this
    ...
    /// <summary>
    /// Returns a new instance where the first element that matches the given one has been removed.
    /// If no changes are detected, returns the original instance instead.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance where the last element that matches the given one has been removed.
    /// If no changes are detected, returns the original instance instead.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
