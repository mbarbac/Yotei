...
// ========================================================
//[Enforced]
public static partial class Test_DbTokenVisitor_Values
{
    //[Enforced]
    [Fact]
    ...
    //[Enforced]
    [Fact]
    public static void Test_TimeSpan()
    {
        var engine = new FakeEngine();
        var connection = new FakeConnection(engine);
        var visitor = new DbTokenVisitor(connection, new());
        string str;
        var value = new TimeSpan(0, 23, 55, 59, 800, 900);
    ...
    //[Enforced]
    [Fact]
    public static void Test_TimeSpan_WithDays_Ignored()
    {
        var engine = new FakeEngine();
        var connection = new FakeConnection(engine);
        var visitor = new DbTokenVisitor(connection, new());
        string str;
        var value = new TimeSpan(1, 23, 55, 59, 800, 900);
