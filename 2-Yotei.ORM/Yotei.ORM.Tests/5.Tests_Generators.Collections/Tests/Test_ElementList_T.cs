...
public static class Test_ElementList_T
{
    ...
    public static void Test_Create_Range()
    {
        ...
        try { _ = new Chain(false, [new TItem("")]); Assert.Fail(); }
    ...
    public static void Test_Create_With_Duplicates()
    {
        ...
        try { _ = new Chain(false, [xone, new TItem("ONE")]); Assert.Fail(); }
        catch (DuplicateException) { }

        try { _ = new Chain(true, [xone, new TItem("one")]); Assert.Fail(); }
        catch (DuplicateException) { }
    }
    ...
    public static void Test_Find()
    {
        ...
        list = items.IndexesOf(new TItem("ONE"));
        Assert.Equal(2, list.Count);
        Assert.Equal(0, list[0]);
        Assert.Equal(3, list[1]);
    }
