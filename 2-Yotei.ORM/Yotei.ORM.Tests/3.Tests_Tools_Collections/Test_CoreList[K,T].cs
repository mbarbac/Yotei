...
public static partial class Test_CoreList_KT
{
    ...
    public partial class Chain : CoreList<string, IElement>, IElement
    {
        ...
        public override bool AcceptDuplicated(IElement source, IElement other) => AllowDuplicates ? true : throw new DuplicateException().WithData(other);
        public override bool FlattenInputs => Flatten;
    ...
    public static void Test_Clone()
    {
        ...
        source = new Chain([xone, xtwo]) { AllowDuplicates = true, IgnoreCase = true, Flatten = true };
        target = source.Clone();
        Assert.NotSame(source, target);
