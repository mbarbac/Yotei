...
public static partial class Test_InvariantList_T
{
    ...
    public partial class Builder : InvariantList<IElement>.CoreBuilder
    {
        public Builder(bool sensitive) : base()
        {
            Sensitive = sensitive;
        ...
        public override Chain ToInvariant() => Count == 0 ? new Chain(Sensitive) : new Chain(this);
    }
    ...
    [Cloneable]
    [DebuggerDisplay("{ToDebugString(3)}")]
    public partial class Chain : InvariantList<IElement>
    {
        protected override Builder Items { get; }

        public Chain(bool sensitive) : base() => Items = new(sensitive);

        public Chain(Builder builder) => Items = builder.ThrowWhenNull().Clone();
        
        public Chain(bool sensitive, IEnumerable<IElement> range)
            : this(sensitive)
            => Items.AddRange(range);

        protected Chain(Chain source) : base(source.ThrowWhenNull()) => Items = source.Items.Clone();
    ...
    public static void Test_Clone()
    {
        ...
        Assert.Same(source.CompareElements, ((Chain)target).CompareElements);
