...
public static class Test_CommandEnumerator
{
    ...
    public static void Test_First()
    {
        ...
        var item = command.FirstOrDefault();
        Assert.Null(item);
    ...
    public static async Task Test_FirstAsync()
    {
        ...
        var item = await command.FirstOrDefaultAsync();
        Assert.Null(item);
        ...
        item = await command.FirstOrDefaultAsync().ConfigureAwait(false);
        Assert.NotNull(item);
        Assert.Equal("007", item[0]);
    }
    ...
    public static void Test_Last()
    {
        ...
        var item = command.LastOrDefault();
        Assert.Null(item);
    ...
    public static async Task Test_LastAsync()
    {
        ...
        var item = await command.LastOrDefaultAsync();
        Assert.Null(item);
        ...
        item = await command.LastOrDefaultAsync().ConfigureAwait(false);
        Assert.NotNull(item);
        Assert.Equal("SP2", item[0]);
    }
