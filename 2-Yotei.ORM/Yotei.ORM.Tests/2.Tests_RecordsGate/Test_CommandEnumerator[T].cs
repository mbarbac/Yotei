...
public static class Test_CommandEnumerator_T
{
    ...
    public static Persona ToPersona(IRecord record, ISchema? _)
    ...
    public static void Test_Simple_Enumerate()
    {
        ...
        List<Persona> items = [];
        foreach (var item in command.ConvertInto(ToPersona)) items.Add(item!);
    ...
    public static void Test_ToList()
    {
        ...
        var items = command.ConvertInto(ToPersona).ToList();
        Assert.Equal(3, items.Count);
        Assert.Equal("007", items[0].Id);
        Assert.Equal("SP1", items[1].Id);
        Assert.Equal("SP2", items[2].Id);
    ...
    public static void Test_First()
    {
        ...
        var item = command.ConvertInto(ToPersona).First();
        Assert.Null(item);
        ...
        item = command.ConvertInto(ToPersona).First();
        Assert.NotNull(item);
    ...
    public static async Task Test_FirstAsync()
    {
        ...
        var item = await command.ConvertInto(ToPersona).FirstAsync();
        Assert.Null(item);
    ...
    public static void Test_Last()
    {
        ...
        var item = command.ConvertInto(ToPersona).Last();
        Assert.Null(item);
        ...
        item = command.ConvertInto(ToPersona).Last();
        Assert.NotNull(item);
    ...
    public static async Task Test_LastAsync()
    {
        ...
        var item = await command.ConvertInto(ToPersona).LastAsync();
        Assert.Null(item);
        ...
        item = await command
            .ConvertInto(ToPersona)
            .LastAsync().ConfigureAwait(false);
    ...
    public static async Task Test_LastAsync_Cancellation()
    {
        ...
        try
        {
            await command
                .ConvertInto(ToPersona)
                .LastAsync(source.Token).ConfigureAwait(false);
