...
public static class Test_IdentifierTags
{
    ...
    public static void Test_Equals()
    {
        ...
        var sthree = new MetadataTag(false, ["threeA", "threeB"]);
        var source = new IdentifierTags(false, [sone, stwo, sthree]);

        var tone = new MetadataTag(false, ["oneA", "oneB"]);
        var ttwo = new MetadataTag(false, ["twoA", "twoB"]);
        var tthree = new MetadataTag(false, ["threeA", "threeB"]);
        var target = new IdentifierTags(false, [tone, ttwo, tthree]);
