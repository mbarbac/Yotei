...
// ========================================================
/// <inheritdoc cref="IIdentifierChainBuilder"/>
[Cloneable]
public partial class IdentifierChainBuilder
    : CoreList<string?, IIdentifierPart>, IIdentifierChainBuilder
{
    /// <summary>
    /// Initializes a new empty instance.
    /// </summary>
    /// <param name="engine"></param>
    public IdentifierChainBuilder(IEngine engine) : base()
    {
    ...
    public IdentifierChainBuilder(IEngine engine, IIdentifierPart item) : this(engine) => Add(item);
    ...
    IdentifierChainBuilder(IdentifierChainBuilder source) : this(source.Engine) => AddRange(source);

    /// <inheritdoc/>
    public override string ToString() => Value ?? string.Empty;

    /// <inheritdoc/>
    public virtual IdentifierChain ToInstance()
    {
        return
            Count == 0 ? new(Engine) :
            Count == 1 ? new(Engine, this[0]) : new(Engine, this);
    }
    IIdentifierChain IIdentifierChainBuilder.ToInstance() => ToInstance();
    ...
    /// <summary>
    /// Returns a not-empty list with the parts obtained from the given value, including an empty
    /// one if the value was null or if the resulting list of strings was empty.
    /// </summary>
    /// <param name="value"></param>
    /// <returns></returns>
