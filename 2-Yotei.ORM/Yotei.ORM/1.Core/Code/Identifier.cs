...
public static class Identifier
{
    ...
    /// <returns></returns>
    public static IIdentifier Create(IEngine engine, string? value = null) => throw null;
    ...
    /// <returns></returns>
    public static IIdentifier Create(IEngine engine, IEnumerable<string?> range) => throw null;
    ...
    /// <returns></returns>
    public static bool Match(IIdentifier item, string? specs) => throw null;
