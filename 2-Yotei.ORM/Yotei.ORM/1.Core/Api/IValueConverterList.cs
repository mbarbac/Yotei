...
// ========================================================
/// <summary>
/// Represents a collection of value converters from their source types to given target ones.
/// Instances of this type are typically used when there are no standard conversions among the
/// application-level types to database ones.
/// </summary>
[Cloneable]
public partial interface IValueConverterList : IEnumerable<IValueConverter>
{
    ...
    /// <summary>
    /// Returns the converter registered for the given source type in this instance , or null if
