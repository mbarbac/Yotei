...
public interface IIdentifier : IEquatable<IIdentifier>
{
    ...
    /// <summary>
    /// Determines if the value of the identifier matches the given specifications, or not.
    /// <br/> Matching is performed by comparing the identifier parts with the given specs, from
    /// right to left, where any empty or null specification is taken as an implicit match.
    /// </summary>
