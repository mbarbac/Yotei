...
public abstract partial class Connection : DisposableClass, IConnection
{
    ...
    {
        // Obtains a valid one unless we are is a disposing or disposed situation...
        get
        {
        ...
        // Needs a setter for when derived classes change the transaction settings...
        protected set
        {
            if (value != null && this != value.Connection) throw new ArgumentException(
