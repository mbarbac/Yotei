...
// ========================================================
/// <summary>
/// An immutable object that describes a database engine.
/// </summary>
public partial interface IEngine
{
    /// <summary>
    /// Determines if this engine treats the identifier-alike names as case sensitive, or not.
    /// </summary>
    [WithGenerator] bool CaseSensitiveNames { get; }

    /// <summary>
    /// The literal used by this engine to represent null or missed valued.
    /// </summary>
    ...
    /// <summary>
    /// The default prefix used by this engine to identifiy names of parameters of a command.
    /// </summary>
    ...
    /// <summary>
    /// Determines if in this engine the names of the identifier-alike elements shall be wrapped
    /// with terminators, or not.
    /// </summary>
