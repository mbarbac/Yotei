...
public record DbTokenParts(DbTokenInvoke? Head, IDbToken Body, DbTokenInvoke? Tail);

// ========================================================
public static class DbTokenPartsExtensions
{
    /// <summary>
    ...
    /// <returns></returns>
    public static DbTokenParts ExtractParts(this IDbToken source)
    {
        ...
        void ExtractHead()
        {
            ...
            while (item is DbTokenHosted hosted)
            {
                if (hosted.Host is DbTokenArgument && hosted is DbTokenInvoke invoke) // Found...
                {
                    ...
                    else ((DbTokenHosted)prev).Host = arg;
