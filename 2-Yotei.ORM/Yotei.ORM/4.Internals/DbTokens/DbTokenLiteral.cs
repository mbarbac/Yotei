...
public partial class DbTokenLiteral : DbToken
{
    ...
    public static bool operator ==(
        DbTokenLiteral? host, DbToken? other) => host?.Equals(other) ?? false;

    public static bool operator !=(DbTokenLiteral? host, DbToken? other) => !(host == other);
    ...
    /// Empty values are considered valid ones.
    /// </summary>
