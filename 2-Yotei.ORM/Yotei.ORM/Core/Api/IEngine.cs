...
public partial interface IEngine
{
    ...
    /// <summary>
    /// The collection of metadata tags that are well-known to the underlying engine.
    /// </summary>
    [WithGenerator]
    ...
    /// instance. Dots wrapped by terminators are not taken into consideration if terminators
    /// are used. The returned array is empty if and only if the given value is a null one.
    /// </summary>
