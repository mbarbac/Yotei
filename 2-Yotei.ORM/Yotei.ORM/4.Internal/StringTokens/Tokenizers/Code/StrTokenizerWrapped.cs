...
// ========================================================
/// <summary>
/// Represents the ability of extracting <see cref="IStrTokenWrapped"/> tokens.
/// </summary>
[InheritWiths]
public partial class StrTokenizerWrapped : StrTokenizer
{
    /// <summary>
    ...
    public StrTokenizerWrapped(string head, string tail)
    {
        Head = head;
        Tail = tail;
    }
    ...
    public StrTokenizerWrapped(string separator) : this(separator, separator) { }
    ...
    /// <param name="head"></param>
    /// <param name="tail"></param>
    public StrTokenizerWrapped(char head, char tail)
    {
    ...
    /// </summary>
    /// <param name="separator"></param>
    public StrTokenizerWrapped(char separator) : this(separator, separator) { }

    /// <summary>
    /// Copy constructor.
    /// </summary>
    /// <param name="source"></param>
    protected StrTokenizerWrapped(StrTokenizerWrapped source) : base(source)
    {
        Head = source.Head;
        Tail = source.Tail;
    ...
    class HeadTokenizer : StrTokenizerLiteral
    {
        public HeadTokenizer(StrTokenizerWrapped master) : base(master.Head)
        {
            Comparison = master.Comparison;
            OnlyText = master.OnlyText;
    ...
    class TailTokenizer : StrTokenizerLiteral
    {
        public TailTokenizer(StrTokenizerWrapped master) : base(master.Tail)
        {
            Comparison = master.Comparison;
            OnlyText = master.OnlyText;
            ValueFromSource = true; // Enforced, we'll treat it as needed...
