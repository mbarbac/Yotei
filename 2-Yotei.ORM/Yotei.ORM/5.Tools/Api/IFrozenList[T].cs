...
public partial interface IFrozenList<T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// Returns a new instance with the first ocurrence of the given element removed from it.
    /// If no changes are detected, returns the original collection.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with the last ocurrence of the given element removed from it.
    /// If no changes are detected, returns the original collection.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with all the ocurrences of the given element removed from it.
    /// If no changes are detected, returns the original collection.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
