...
/// <br/> Duplicate elements are allowed if and only if they are the same instance. Otherwise,
/// elements with the same name are not allowed.
/// </summary>
public interface IParameterList : IEnumerable<IItem>
{
    /// <summary>
    ...
    /// <summary>
    /// Returns the next parameter name based upon the contents in this collection.
    /// </summary>
    /// <returns></returns>
    string NextName();
    ...
    /// <summary>
    /// Returns a new instance where the elements from the given range have been inserted,
    /// starting at the given index, into the original collection.
    /// </summary>
    /// <param name="index"></param>
    /// <param name="range"></param>
    /// <returns></returns>
