...
// ========================================================
/// <summary>
/// Represents the immutable collection of metadata pairs associated with an entry in a record.
/// </summary>
[Cloneable]
public partial interface ISchemaEntry : IEnumerable<TPair>
{
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    THost Add(string tag, object? value);
    ...
    /// <param name="range"></param>
    /// <returns></returns>
    THost RemoveRange(IEnumerable<string> range);
