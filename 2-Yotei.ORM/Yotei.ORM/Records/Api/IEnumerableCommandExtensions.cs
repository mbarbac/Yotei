...
public static class IEnumerableCommandExtensions
{
    ...
    /// <returns></returns>
    public static List<Records.IRecord> ToList(this Records.IEnumerableCommand command)
    {
        command.ThrowWhenNull();

        var list = new List<Records.IRecord>();
    ...
    /// <returns></returns>
    public async static ValueTask<List<Records.IRecord>> ToListAsync(this Records.IEnumerableCommand command, CancellationToken token = default)
    {
        command.ThrowWhenNull();
    ...
    public static Records.IRecord[] ToArray(this Records.IEnumerableCommand command)
    {
    ...
    /// <returns></returns>
    [SuppressMessage("", "IDE0305")]
    public async static ValueTask<Records.IRecord[]> ToArrayAsync(this Records.IEnumerableCommand command, CancellationToken token = default)
    {
        command.ThrowWhenNull();
    ...
    /// <param name="command"></param>
    /// <returns></returns>
    public static Records.IRecord? First(this Records.IEnumerableCommand command)
    {
        command.ThrowWhenNull();
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public async static ValueTask<Records.IRecord?> FirstAsync(this Records.IEnumerableCommand command, CancellationToken token = default)
    {
        command.ThrowWhenNull();
    ...
    /// <param name="command"></param>
    /// <returns></returns>
    public static Records.IRecord? Last(this Records.IEnumerableCommand command)
    {
        command.ThrowWhenNull();

        Records.IRecord? result = null;
        using var iter = command.GetEnumerator();
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public async static ValueTask<Records.IRecord?> LastAsync(this Records.IEnumerableCommand command, CancellationToken token = default)
    {
        command.ThrowWhenNull();
