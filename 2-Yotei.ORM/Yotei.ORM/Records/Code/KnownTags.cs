...
public partial class KnownTags : IKnownTags
{
    ...
    public KnownTags(bool sensitiveTags)
    {
        _CaseSensitiveTags = sensitiveTags;
        _IdentifierTags = new IdentifierTags(sensitiveTags);
    }
    ...
    public bool CaseSensitiveTags
    {
        ...
        init
        {
            ...
            _IdentifierTags = new IdentifierTags(value);
            _PrimaryKeyTag = null;
