...
// ========================================================
partial class InvariantList<T>
{
    /// <summary>
    /// <inheritdoc cref="IInvariantList{T}.ICoreBuilder"/>
    /// </summary>
    [Cloneable(ReturnType = typeof(IInvariantList<>.ICoreBuilder))]
    [DebuggerDisplay("{ToDebugString(3)}")]
    public partial class CoreBuilder : CoreList<T>, IInvariantList<T>.ICoreBuilder
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IInvariantList<T> ToInvariant() => Count == 0
            ? []
            : new InvariantList<T>(this);
    }
}
...
public partial class InvariantList<T> : IInvariantList<T>
{
    ...
    /// </summary>
    protected virtual IInvariantList<T>.ICoreBuilder Items { get; }
    ...
    /// Initializes a new empty instance.
    /// </summary>
    public InvariantList() => Items = new InvariantList<T>.CoreBuilder();
    ...
    public InvariantList(
        IInvariantList<T>.ICoreBuilder builder) => Items = builder.ThrowWhenNull().Clone();
    ...
    protected InvariantList(
        InvariantList<T> source) => Items = source.ThrowWhenNull().Items.Clone();
    ...
    /// </summary>
    /// <returns></returns>
    public virtual IInvariantList<T>.ICoreBuilder ToBuilder() => Items.Clone();
    ...
    {
        var builder = Items.Clone();
        var num = builder.RemoveLast(item, removed);
        return num > 0 ? builder.ToInvariant() : this;
    }
    ...
    {
        var builder = Items.Clone();
        var num = builder.RemoveLast(item, out removed);
        return num > 0 ? builder.ToInvariant() : this;
    }
