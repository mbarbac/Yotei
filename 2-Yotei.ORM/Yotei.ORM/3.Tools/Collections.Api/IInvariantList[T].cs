...
public partial interface IInvariantList<T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Returns a new instance with the first ocurrence of the given element removed.
    /// <br/> Returns the original instance if no changes were made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with the last ocurrence of the given element removed.
    /// <br/> Returns the original instance if no changes were made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance with all the ocurrences of the given element removed.
    /// <br/> Returns the original instance if no changes were made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
