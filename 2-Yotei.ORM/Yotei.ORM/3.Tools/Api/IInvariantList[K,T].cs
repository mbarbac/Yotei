...
public partial interface IInvariantList<K, T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Gets the index of the first element in this collection with the given key, or -1 if any
    /// is found.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Gets the index of the last element in this collection with the given key, or -1 if any
    /// is found.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance where all the elements with the given key has been removed.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
