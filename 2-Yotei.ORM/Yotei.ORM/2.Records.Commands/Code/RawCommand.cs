...
{
    readonly CommandInfo.Builder _Info;
    ...
    /// <inheritdoc/>
    public override CommandInfo GetCommandInfo() => _Info.CreateInstance();

    /// <inheritdoc/>
    public override CommandInfo GetCommandInfo(bool _) => _Info.CreateInstance();
