...
partial interface IRecord
{
    ...
    public partial interface IBuilder : IEnumerable<object?>
    {
        ...
        /// <summary>
        /// Keeps the given number of original elements, starting at the given index, discarding
        /// the remaining ones.
        /// </summary>
        /// <param name="index"></param>
        /// <param name="count"></param>
        ...
        /// <summary>
        /// Replaces the value and schema entry at the given index with the new given ones.
        ...
        /// <summary>
        /// Adds the given value and schema entry to this instance.
        /// <br/> This method throw an exception if this instance is a schema-less one.
        /// <br/> Returns whether changes have been made, or not.
        /// </summary>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Adds the values and schema entries from the given ranges to this instance.
        /// <br/> This method throw an exception if this instance is a schema-less one.
        /// <br/> Returns whether changes have been made, or not.
        /// </summary>
        /// <param name="range"></param>
        ...
        /// <summary>
        /// Inserts the values and schema entries from the given ranges into this instance, starting
        /// at the given index.
        /// <br/> This method throw an exception if this instance is a schema-less one.
        /// <br/> Returns whether changes have been made, or not.
        /// </summary>
        ...
        /// <summary>
        /// Removes from this instance the given number of values and schema entries, if any,
        /// stating from the given index.
        /// <br/> Returns whether changes have been made, or not.
        /// </summary>
        /// <param name="index"></param>
        /// <param name="count"></param>
