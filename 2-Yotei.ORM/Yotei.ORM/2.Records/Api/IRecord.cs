...
// ========================================================
/// <summary>
/// Represents an ordered collection of related values to be retrieved from or persisted into
...
public partial interface IRecord : IEnumerable<object?>, IEquatable<IRecord>
{
    ...
    /// <br/> Schema-full ones compare the values associated to similar identifiers, in source
    /// order.
    /// </summary>
