...
public interface IRecordsGate
{
    ...
    /// <summary>
    /// Returns a new command of the appropriate type for this instance, using the the text and
    /// optional arguments obtained from parsing the given dynamic lambda expression.
    /// </summary>
    /// <param name="specs"></param>
    /// <returns></returns>
    IRawCommand Raw(Func<dynamic, object> specs);
}