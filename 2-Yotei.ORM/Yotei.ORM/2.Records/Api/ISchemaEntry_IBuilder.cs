...
partial interface ISchemaEntry
{
    ...
    public partial interface IBuilder : IEnumerable<IMetadataEntry>
    {
        ...
        /// <summary>
        /// Determines if this instance is a primary key, or is part of a primary key group,
        /// or not.
        /// </summary>
        bool IsPrimaryKey { get; set; }

        /// <summary>
        /// Determines if this instance is a unique valued one, or is part of a unique valued
        /// group, or not.
        /// </summary>
        ...
        /// <summary>
        /// Tries to obtain the metadata pair whose tag contains the given name.
        /// </summary>
        ...
        /// <summary>
        /// Tries to obtain the metadata pair whose tag contains the any of the names from the
        /// given range.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the internal capacity of this collection.
        /// </summary>
