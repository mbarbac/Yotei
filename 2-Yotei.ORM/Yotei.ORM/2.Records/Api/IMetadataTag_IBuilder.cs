...
partial interface IMetadataTag
{
    ...
    public partial interface IBuilder : IEnumerable<string>
    {
        ...
        /// <br/> The setter throws an exception if the given tag name is not part of this
        /// collection.
        /// </summary>
        ...
        /// <summary>
        /// Removes the given name from this collection. If it was the only one in this collction,
