...
partial class SchemaEntry
{
    ...
    public partial class Builder : ISchemaEntry.IBuilder
    {
        ...
        /// <summary>
        /// Gets the index of the metadata pair that contains the given name, or -1 if not found.
        /// </summary>
        ...
        /// <summary>
        /// Gets the index of the metadata pair that contains any name from the given range, or
        /// -1 if not found.
        /// </summary>
        ...
        /// <inheritdoc/>
        public virtual bool Replace(string name, IMetadataEntry item)
        {
            name = name.NotNullNotEmpty();
            item.ThrowWhenNull();
        ...
        /// <inheritdoc/>
        public virtual bool Replace(IEnumerable<string> range, IMetadataEntry item)
        {
            range.ThrowWhenNull();
            item.ThrowWhenNull();
        ...
        /// <inheritdoc/>
        public virtual bool ReplaceValue(string name, object? value)
        {
            name = name.NotNullNotEmpty();
        ...
        /// <inheritdoc/>
        public virtual bool ReplaceValue(IEnumerable<string> range, object? value)
        {
            range.ThrowWhenNull();
        ...
        /// <inheritdoc/>
        public virtual bool Remove(IEnumerable<string> range)
        {
            range.ThrowWhenNull();
