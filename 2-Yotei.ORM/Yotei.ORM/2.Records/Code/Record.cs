...
public partial class Record : IRecord
{
    ...
    /// <inheritdoc/>
    public bool TryGet(
        string identifier, out object? value, [NotNullWhen(true)] out ISchemaEntry? entry)
    ...
    /// <inheritdoc/>
    public IRecord InsertRange(int index, IEnumerable<object?> range, IEnumerable<ISchemaEntry> entries)
    {
        var builder = GetBuilder();
