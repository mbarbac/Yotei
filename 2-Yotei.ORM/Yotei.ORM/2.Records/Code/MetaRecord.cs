...
// ========================================================
/// <inheritdoc cref="IMetaRecord"/>
public class MetaRecord : IMetaRecord
{
    /// <summary>
    ...
    public MetaRecord(IRecord record, ISchema schema)
    {
    ...
    /// <inheritdoc/>
    public bool Equals(IMetaRecord? other)
    {
    ...
    public static bool operator ==(MetaRecord x, IMetaRecord y) => x is not null && x.Equals(y);
    public static bool operator !=(MetaRecord x, IMetaRecord y) => !(x == y);
