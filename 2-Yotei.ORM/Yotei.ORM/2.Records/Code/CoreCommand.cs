...
// ========================================================
/// <summary>
/// Represents a text-based command that can be executed against an underlying database.
/// </summary>
[Cloneable]
public partial class CoreCommand : ORM.Code.Command, IEnumerableCommand, IExecutableCommand
{
    ...
    public CoreCommand(IConnection connection)
        : base(connection)
    ...
    protected CoreCommand(CoreCommand source)
    ...
    /// <returns></returns>
    public CoreCommand Add(string? specs, params object?[] args)
    {
        Info.Add(specs, args);
        return this;
    }
