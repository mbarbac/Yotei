...
partial class Record
{
    ...
    public partial class Builder : IRecord.IBuilder
    {
        ...
        /// <summary>
        /// Initializes a new schema-full instance with the values and schema entries from the
        /// given ranges.
        /// </summary>
        /// <param name="engine"></param>
        /// <param name="range"></param>
        ...
        protected Builder(Builder source)
        {
            ...
            if (source._Schema != null) _Schema = new(source._Schema.Engine, source._Schema);
        ...
        /// <inheritdoc/>
        public bool TryGet(string identifier, out object? value, [NotNullWhen(true)] out ISchemaEntry? entry)
        {
            ThrowIfSchemaLess();
        ...
        public bool InsertRange(int index, IEnumerable<object?> range)
        {
            ...
            foreach (var item in range)
                if (Insert(index, item)) { done = true; index++; }
