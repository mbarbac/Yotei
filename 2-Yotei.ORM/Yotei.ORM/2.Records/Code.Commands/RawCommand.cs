...
public partial class RawCommand : Command, IRawCommand
{
    ...
    /// <summary>
    /// Initializes a new instance with  the text and optional arguments obtained from parsing
    /// the given dynamic lambda expression.
    /// </summary>
    /// <param name="connection"></param>
    /// <param name="specs"></param>
    public RawCommand(IConnection connection, Func<dynamic, object> specs)
        : this(connection)
        => Append(specs);
