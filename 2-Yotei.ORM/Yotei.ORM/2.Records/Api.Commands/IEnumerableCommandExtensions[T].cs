...
public static class IEnumerableCommandExtensions_T
{
    ...
    public static List<T> ToList<T>(
        this IEnumerableCommand command, Func<IMetaRecord, T> converter) where T : class
    {
        ...
        while (iter.MoveNext())
        {
            var r = converter(new MetaRecord(iter.Current!, iter.Schema!));
        ...
        this IEnumerableCommand command, Func<IMetaRecord, T> converter) where T : class
    {
        ...
        while (iter.MoveNext())
        {
            var temp = converter(new MetaRecord(iter.Current!, iter.Schema!));
            if (temp != null) r = temp;
        }
        return r;
    }
