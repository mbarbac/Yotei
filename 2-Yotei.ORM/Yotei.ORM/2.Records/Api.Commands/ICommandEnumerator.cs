...
/// produced by that that execution.
/// </summary>
    ...
    , IEnumerator<IRecord?>, IAsyncEnumerator<IRecord?>
{
    ...
    /// <summary>
    /// The schema that describes the records produced by this instance, or null if it has not
    /// been executed yet.
    /// </summary>
    ISchema? Schema { get; }

    /// <summary>
    /// The record produced by the current iteration of this enumerator, or null if it has not
    /// been executed yet, or if there are no more records available.
    /// </summary>
