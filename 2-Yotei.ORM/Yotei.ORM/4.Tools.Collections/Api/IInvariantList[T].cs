...
// ========================================================
/// <summary>
/// Represents an immutable customizable list-alike collection of elements.
...
public partial interface IInvariantList<T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Returns the index of the first ocurrence in this this collection of the given element,
    /// or -1 if not found.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns the index of the last ocurrence in this this collection of the given element,
    /// or -1 if not found.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance where the all the ocurrences of the given element have been removed.
    /// <br/> Returns either a new instance or the original one if not changes have been made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
