...
public static partial class Fragment
{
    ...
    /// </summary>
    [Cloneable]
    public partial class Master : IEnumerable<Entry>
    {
        ...
        /// <inheritdoc/>
        public override string ToString() => Visit().Text;
        ...
        /// <summary>
        /// Invoked to create a new entry of the appropriate type for this instance.
        /// </summary>
        /// <param name="body"></param>
        /// <returns></returns>
        protected virtual Entry Create(DbToken body) => new(body);

        // ------------------------------------------------

        /// <summary>
        /// The separator used between two consecutive entries in this collection.
        /// <br/> If the value of this property is null, then it is ignored.
        /// </summary>
