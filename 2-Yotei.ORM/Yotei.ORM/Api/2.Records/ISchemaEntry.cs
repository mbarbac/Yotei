...
// ========================================================
/// <summary>
/// Represents the collection of metadata (tags, value) pairs that describes an entry in a record.
/// <br/> Duplicated tag names across its properties are not allowed.
/// </summary>
[Cloneable]
