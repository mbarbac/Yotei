...
// ========================================================
/// <summary>
/// Represents the ability of parsing <see cref="IDbToken"/> instances returning the appropriate
/// <see cref="ICommandInfo.IBuilder"/> one that represents that token in a format understandable
