...
// ========================================================
/// <summary>
/// Represents a string token that carries an arbitrary not-null and not-empty value that will not
/// be tokenized any further. Spaces-only values are considered acceptable.
