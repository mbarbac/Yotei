...
// ========================================================
/// <summary>
/// Represents a string token that carries an arbitrary not-null and not-empty literal value that
/// will not be tokenized any further. Spaces-only values are considered acceptable.
/// <br/> Instances of this type are intended to be immutable ones.
/// </summary>
public class StrTokenLiteral : IStrToken
{
    /// <summary>
    /// Initializes a new instance with the given not-null and not-empty payload.
    /// </summary>
    ...
    public virtual bool Equals(IStrToken? other, StringComparison comparison)
    {
        ...
        if (other is not StrTokenLiteral valid) return false;
    ...
    /// <inheritdoc/>
    /// Literal tokens are not intended to be reduced.
