...
// ========================================================
/// <summary>
/// Represents the ability of extracting arbitrary <see cref="StrTokenText"/> tokens.
/// </summary>
[InheritWiths]
public partial class StrTextTokenizer : StrTokenizer
{
    /// <summary>
    /// Initializes a new instance.
    /// </summary>
    /// <param name="value"></param>
    public StrTextTokenizer(string value) => Value = value;

    /// <summary>
    /// Initializes a new instance.
    /// </summary>
    /// <param name="value"></param>
    public StrTextTokenizer(char value)
    {
    ...
    protected StrTextTokenizer(StrTextTokenizer source) : base(source)
    {
        Value = source.Value;
    ...
    /// <br/> Note that spaces-only values are considered valid ones.
    /// </summary>
    [With]
    public string Value
    {
