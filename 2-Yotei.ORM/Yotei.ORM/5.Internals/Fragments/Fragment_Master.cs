...
public static partial class Fragment
{
    ...
    public abstract partial class Master : IEnumerable<Entry>
    {
        ...
        /// the expression resolves to a string having those arguments encoded in it using either
        /// posional '{n}' or named '{name}' formats.
        /// <br/> If the expression does not resolve to a string value, or if there is a mismatch
        /// between the encoded specifications and the actual number of arguments, an exception
        /// is thrown.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Invoked to create a suitable entry based upon the given dynamic lambda expression.
        /// <para>
        /// This method accepts an optional collection of arguments that will only be used when
        /// the expression resolves to a string having those arguments encoded in it using either
        /// posional '{n}' or named '{name}' formats.
        ...
        public Entry CreateEntry(Func<dynamic, object> spec, params object?[]? args)
        {
            ...
            // Intercepting when arguments are given...
            if (args is null || args.Length > 0)
            {
                ...
                else
                {
                    throw new ArgumentException(
                        "Arguments are used with no valid string receiver.")
                        .WithData(token)
                        .WithData(args);
                }
            }
        ...
        /// <summary>
        /// Visits the entries in this instance and returns a command info builder object that
        ...
        /// whose format is:
        /// <br/> ICommandInfo.IBuilder (Entry, DbTokenVisitor, bool entryNeedsSeparation)
        /// </summary>
