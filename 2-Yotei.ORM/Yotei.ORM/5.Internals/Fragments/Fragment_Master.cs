...
static partial class Fragment
{
    // ====================================================
    /// <summary>
    /// Represents the collection of fragments used to buil a given clause in the associated
    /// command.
    /// </summary>
    public abstract class Master : IEnumerable<Entry>
    {
        ...
        /// <summary>
        /// Creates and adds to this collection a valid entry parsing the given dynamic lambda
        /// expression. If that expression resolved into a string, and if there is a collection
        /// of arguments given, then those arguments are used to build a command-info token that
        /// will be used to create the entry instead.
        /// </summary>
        ...
        /// <summary>
        /// Invoked to visit the entries in this instance using the given delegate concatenating
        /// the results. The delegate signature is:
