...
public static partial class FragmentRaw
{
    // ====================================================
    /// <summary>
    /// Represents an entry in a collection of fragments used to build RAW-alike clauses.
    /// </summary>
    [Cloneable]
    ...
    // ====================================================
    /// <summary>
    /// Represents the collection of fragments used to build RAW-alike clauses.
    /// </summary>
    [Cloneable]
    public partial class Master : Fragment.Master
    {
        ...
        public Master(ICommand command, string clause = "RAW") : base(command, clause) { }
