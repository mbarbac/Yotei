    ...
    public sealed partial class Builder : ICommandInfo.IBuilder
    {
            ...
            string? text, params object?[]? range)
        {
            ...
            if (items.Length == 1)
            {
                ...
                {
                    text = TextToOrdinalBrackets(text, parList, Comparison);
                    range = parList.ToArray();
                    return Add(noRemainingSpecs, noUnusedValues, text, range);
                }
                if (items[0].Value is IParameterList.IBuilder parBuilder) // Special case...
                {
                    text = TextToOrdinalBrackets(text, parBuilder, Comparison);
        ...
        /// <summary>
        /// Translates the parameter names in the given text to bracket specifications.
        /// </summary>
        /// <param name="text"></param>
        /// <param name="pars"></param>
        /// <param name="comparison"></param>
        /// <returns></returns>
        static string? TextToOrdinalBrackets(
        ...
        /// text, starting at the given position, or -1 if any is found. If found, the bracket
        /// itself is returned in the out argument.
        /// </summary>
        ...
        /// text, starting at the given position, or -1 if any is found. If found, the bracket
        /// itself is returned in the out argument.
        /// <br/> The 'name' is tested with and without the engine parameters' prefix, as needed.
        /// </summary>
        ...
        /// and into the <paramref name="captured"/> collection (keeping track of the new added
        /// ones to prevent duplicated new names). Returns either the given parameter, or a new
        /// one created to prevent name collision with original ones.
        /// </summary>
        /// <param name="par"></param>
