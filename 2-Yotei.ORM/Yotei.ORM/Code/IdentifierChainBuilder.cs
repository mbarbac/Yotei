...
[Cloneable]
public sealed partial class IdentifierChainBuilder : CoreList<K?, T>
{
    /// <summary>
    /// Initializes a new empty instance.
    /// </summary>
    /// <param name="engine"></param>
    public IdentifierChainBuilder(IEngine engine)
    {
    ...
    public IdentifierChainBuilder(IEngine engine, T item) : this(engine) => Add(item);
    ...
    public IdentifierChainBuilder(IEngine engine, IEnumerable<T> range) : this(engine) => AddRange(range);
    ...
    /// </summary>
    /// <returns></returns>
    public IIdentifierChain ToInstance() =>
        Count == 0 ? new IdentifierChain(Engine) :
        Count == 1 ? new IdentifierChain(Engine, this[0]) : new IdentifierChain(Engine, this);
    ...
    public void Reduce()
    {
        ...
        _Value = null; // Signals to recompute the value...
    }
