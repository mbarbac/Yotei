...
// ========================================================
/// <summary>
/// Represents a list-alike collection of elements that provides custom item validation and
/// duplicates acceptance or denial capabilities.
/// </summary>
/// <typeparam name="T"></typeparam>
public interface ICoreList<T> : IList<T>, IList, ICollection<T>, ICollection, IEnumerable<T>
{
    /// <summary>
    ...
    /// <summary>
    /// The (source, target) delegate invoked to compare a source element in this instance
    /// against the given target one.
    /// </summary>
    ...
    /// <summary>
    /// Determines if this instance has at least one element that matches the given one.
    /// </summary>
    ...
    /// <summary>
    /// Returns the index of the first element in this instance that matches the given one, or
    /// -1 if any is found.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns the index of the last element in this instance that matches the given one, or
    /// -1 if any is found.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns the indexes of the elements in this instance that match the given one.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes the first element that matches the given one. Returns how many changes have been
    /// made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes the last element that matches the given one. Returns how many changes have been
    /// made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes all the elements that match the given one. Returns how many changes have been
    /// made.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
