...
public partial interface IInvariantList<T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Gets the index all the ocurrences of the given element in this collection.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <returns></returns>
    IInvariantList<T> Reverse();

    /// <summary>
    /// Returns a new instance where the elements of the original collection have been sorted
    /// using the given comparer for its elements.
    /// </summary>
    /// <param name="comparer"></param>
    IInvariantList<T> Sort(IComparer<T> comparer);
