...
[Cloneable]
public partial interface IInvariantList<K, T>
    : IReadOnlyList<T>, IReadOnlyCollection<T>, ICollection
{
    ...
    /// <summary>
    /// Returns a copy of this instance where the given value has been added inserted into it at
    /// the given index.
    /// </summary>
    /// <param name="index"></param>
    /// <param name="value"></param>
    ...
    /// <summary>
    /// Returns a copy of this instance where the all the ocurrences of elements with the given
    /// key, if any, have been removed.
    /// </summary>
    /// <param name="key"></param>
    /// <returns>A new copy, or this instance if no changes have been made.</returns>
