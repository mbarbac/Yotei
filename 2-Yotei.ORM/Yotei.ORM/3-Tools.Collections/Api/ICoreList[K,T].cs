...
public partial interface ICoreList<K, T> : IList<T>, IList, ICollection<T>, ICollection
{
    ...
    /// <summary>
    /// Removes from this collection the first ocurrence of an element with the given key, if any.
    /// </summary>
    /// <param name="key"></param>
    /// <returns>The number of changes made.</returns>
    int Remove(K key);
    ...
    /// <summary>
    /// Removes from this collection the last ocurrence of an element with the given key, if any.
    /// </summary>
    /// <param name="key"></param>
    /// <returns>The number of changes made.</returns>
    ...
    /// <summary>
    /// Removes from this collection all the ocurrences of elements with the given key, if any.
    /// </summary>
    /// <param name="key"></param>
    /// <returns>The number of changes made.</returns>
    int RemoveAll(K key);
