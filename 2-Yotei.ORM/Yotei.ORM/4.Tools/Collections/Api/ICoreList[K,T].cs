...
// ========================================================
/// <summary>
/// Represents a customizable list-alike collection of elements identified by their respective
/// keys.
/// </summary>
    ...
    , IList, ICollection
{
    ...
    /// <br/> If an empty enumeration is given, then nothing is replaced (so acts not as Remove).
