using THost = Experimental.Templates.Code.InvariantListKT;
using TItem = Experimental.Templates.Code.InvariantElement;
...
public static class Test_InvariantList_KT
{
    ...
    {
        var items = new THost(false, [xone, xone]);
    ...
    public static void Test_Equality()
    {
        ...
        source = new THost(true, [xone, xtwo]);
        target = new THost(true, [new TItem("one"), new TItem("TWO")]);
