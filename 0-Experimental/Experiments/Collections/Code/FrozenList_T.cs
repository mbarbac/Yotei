...
// ========================================================
/// <summary>
/// <inheritdoc cref="IFrozen{T}"/>
/// </summary>
/// <typeparam name="T"></typeparam>
[DebuggerDisplay("{ToDebugString(6)}")]
[Cloneable]
public partial class FrozenList<T> : IFrozen<T>
{
    /// <summary>
    ...
    /// <returns></returns>
    public virtual IFrozen<T> GetRange(int index, int count)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> Replace(int index, T item)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> Add(T item)
    {
        var clone = Clone();
    ...
    /// <param name="range"></param>
    /// <returns></returns>
    public virtual IFrozen<T> AddRange(IEnumerable<T> range)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> Insert(int index, T item)
    {
        var clone = Clone();
    ...
    /// <param name="range"></param>
    /// <returns></returns>
    public virtual IFrozen<T> InsertRange(int index, IEnumerable<T> range)
    {
        var clone = Clone();
    ...
    /// <param name="index"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveAt(int index)
    {
        var clone = Clone();
    ...
    /// <param name="count"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveRange(int index, int count)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> Remove(T item)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveLast(T item)
    {
        var clone = Clone();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveAll(T item)
    {
        var clone = Clone();
    ...
    /// <param name="predicate"></param>
    /// <returns></returns>
    public virtual IFrozen<T> Remove(Predicate<T> predicate)
    {
        var clone = Clone();
    ...
    /// <param name="predicate"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveLast(Predicate<T> predicate)
    {
        var clone = Clone();
    ...
    /// <param name="predicate"></param>
    /// <returns></returns>
    public virtual IFrozen<T> RemoveAll(Predicate<T> predicate)
    {
        var clone = Clone();
    ...
    /// </summary>
    /// <returns></returns>
    public virtual IFrozen<T> Clear()
    {
        var clone = Clone();
