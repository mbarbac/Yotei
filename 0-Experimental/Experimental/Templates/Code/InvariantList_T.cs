...
public partial class InvariantList<T> : IInvariantList<T>
{
    ...
    protected InvariantList(InvariantList<T> source) : this() => AddRangeInternal(source);
    ...
    /// <summary>
    /// Validates the given element before using it in this collection for the purposes of the
    /// given scenario: true when adding or inserting, or false otherwise.
    /// </summary>
    ...
    /// <summary>
    /// Determines if the two given elements shall be considered equal or not.
    /// </summary>
    protected virtual bool Compare(T source, T target)
    {
