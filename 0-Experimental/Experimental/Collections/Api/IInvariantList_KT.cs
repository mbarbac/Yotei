...
public interface IInvariantList<K, T> : ICollection, IEnumerable<T>
{
    ...
    /// <summary>
    /// Returns a new instance where the first element with the given key, based upon the equality
    /// rules implemented by this instance, has been removed. If no changes are detected, returns
    /// the original instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a new instance where the last element with the given key, based upon the equality
    /// rules implemented by this instance, has been removed. If no changes are detected, returns
    /// the original instance.
    /// </summary>
    /// <param name="key"></param>
    ...
    /// <summary>
    /// Returns a new instance where all the elements with the given key, based upon the equality
    /// rules implemented by this instance, have been removed. If no changes are detected, returns
    /// the original instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
