...
public interface IInvariantList<T> : ICollection, IEnumerable<T>
{
    ...
    /// <summary>
    /// Determines if this collection contains the given element, base upon the equality rules
    ...
    /// if it cannot be found, base upon the equality rules implemented by this instance.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    int IndexOf(T item);
    ...
    /// <summary>
    /// Returns the indexes of the ocurrences of the given element in this collection, base upon
    /// the equality rules implemented by this instance.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// given one. The element may not be replaced if it is the same as the existing one, based
    /// upon the equality rules implemented by this instance. If no changes are detected, returns
    ...
    /// <summary>
    /// Returns a new instance where the given element has been added to the collection. Addition
    /// may be rejected if duplicates are found base upon the equality rules implemented by this
    /// instance. If no changes are detected, returns the original instance.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// collection. Additions may be rejected if duplicates are found base upon the equality
    /// rules implemented by this instance. If no changes are detected, returns the original
    /// instance.
    /// </summary>
    ...
    /// the given index. Insertion may be rejected if duplicates are found base upon the equality
    /// rules implemented by this instance. If no changes are detected, returns the original
    /// instance.
    /// </summary>
    /// <param name="index"></param>
    ...
    /// collection, starting at the given index. Insertions may be rejected if duplicates are
    /// found base upon the equality rules implemented by this instance. If no changes are
    ...
    /// original collection. Removal may be rejected by this instance based upon the concrete
    /// rules it implements. If no changes are detected, returns the original instance.
    /// </summary>
    /// <param name="index"></param>
    /// <returns></returns>
    ...
    /// have been removed from the collection. Removals may be rejected by this instance based
    /// upon the concrete rules it implements. If no changes are detected, returns the original
    /// instance.
    /// </summary>
    /// <param name="index"></param>
    /// <param name="count"></param>
    ...
    /// <summary>
    /// Returns a new instance where the first ocurrence of the given element, base upon the
    /// equality rules implemented by this instance, has been removed. If no changes are detected,
    ...
    /// <summary>
    /// Returns a new instance where the last ocurrence of the given element, base upon the
    /// equality rules implemented by this instance, has been removed. If no changes are detected,
    /// returns the original instance.
    /// </summary>
    /// <param name="item"></param>
    ...
    /// <summary>
    /// Returns a new instance where all the ocurrences of the given element, base upon the
    /// equality rules implemented by this instance, have been removed. If no changes are
    /// detected, returns the original instance.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
