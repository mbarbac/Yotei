...
// ========================================================
/// <summary>
/// Represents a list-alike collection of elements identified by their keys, with customizable
/// behavior.
/// </summary>
/// <typeparam name="K"></typeparam>
/// <typeparam name="T"></typeparam>
public interface ICustomList<K, T> : IList<T>, IList, ICollection<T>, ICollection
{
    /// <summary>
    ...
    /// <summary>
    /// Determines if this collection contains an element with the given key, using the rules
    ...
    /// key, or -1 if it cannot be found, using the rules implemented by this instance.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    int IndexOf(K key);
    ...
    /// <summary>
    /// Removes from this collection the first element with the given key, using the rules
    ...
    /// <summary>
    /// Removes from this collection the last element with the given key, using the rules
    /// implemented by this instance. Returns the number of changes made, or cero if any.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection the elements with the given key, using the rules implemented
    /// by this instance. Returns the number of changes made, or cero if any.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
