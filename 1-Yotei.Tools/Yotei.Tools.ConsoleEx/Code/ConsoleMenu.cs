...
public class ConsoleMenu : IEnumerable<ConsoleMenuEntry>
{
    ...
    /// <summary>
    /// Runs this menu so that the user can select a given entry and press [Enter] to execute its
    /// associated action, or press [Cancel] to exit the menu. Returns the cero-based position of
