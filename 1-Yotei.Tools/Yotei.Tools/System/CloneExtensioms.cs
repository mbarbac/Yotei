...
{
    /// <summary>
    /// Returns either a clone of the given source, or the source itself if its type is not
    /// a cloneable one, or it has not a suitable <c>Clone()</c> method.
    /// </summary>
    ...
    /// </summary>
    readonly static Dictionary<Type, MethodInfo?> _Methods = new();
