...
public static partial class EasyNameExtensions
{
    ...
    static string EasyName(this Type source, Type[] types, EasyNameOptions options)
    {
        ...
        if (options.TypeNullableStyle != EasyNullableStyle.KeepWrappers &&
            need == 1 &&
            source.IsNullableWrapper())
        {
            ...
            if (options.TypeNullableStyle == EasyNullableStyle.UseAnnotations &&
                !str.EndsWith('?'))
                str += '?';
        ...
        // Nullability...
        while (options.TypeNullableStyle != EasyNullableStyle.None && sb.Length > 0 && sb[^1] != '?')
        {
            if (options.TypeNullableStyle == EasyNullableStyle.KeepWrappers &&
                source.IsNullableWrapper())
                break;
    ...
    public static string EasyName(this ParameterInfo source, EasyNameOptions options)
    {
        ...
        if (options.ArgumentTypeOptions != null)
        {
            ...
            // Nullability...
            while (xoptions.TypeNullableStyle != EasyNullableStyle.None &&
                sb.Length > 0 &&
                sb[^1] != '?')
            {
                if (xoptions.TypeNullableStyle == EasyNullableStyle.KeepWrappers &&
