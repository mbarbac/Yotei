...
{
    /// <summary>
    /// Returns an alternate string representation of the given source value, using the default
    /// options.
    /// </summary>
    ...
    public static string Sketch<T>(this T? source, SketchOptions options)
    {
        ...
        switch (source)
        {
            case Type item: return item.EasyName(options.ReflectionOptions);
            case MethodInfo item: return item.EasyName(options.ReflectionOptions);
            case ConstructorInfo item: return item.EasyName(options.ReflectionOptions);
            case PropertyInfo item: return item.EasyName(options.ReflectionOptions);
            case FieldInfo item: return item.EasyName(options.ReflectionOptions);
        }
