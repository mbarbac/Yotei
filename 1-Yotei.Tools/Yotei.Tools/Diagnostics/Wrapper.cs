...
public static class Wrapper
{
    ...
    /// </summary>
    internal static object?[] NullArray { get; } = new object?[] { null };
    ...
    /// <summary>
    /// Splits the given source in its regular and new line parts, also including the later in
    /// the returned array by default. If the source string is null or empty, then an empty array
    /// is returned.
    /// </summary>
    /// <param name="source"></param>
    /// <returns></returns>
    public static string[] TokenizeNL(string? source, bool addNL = true)
    {
    ...
    /// <summary>
    /// Returns a spaces-only string of the requested lenght.
    /// </summary>
    ...
    readonly static Dictionary<int, string> Headers = new();
}