...
public partial interface ICoreList<K, T> : IList<T>, IList, ICollection<T>, ICollection
{
    ...
    /// <summary>
    /// Removes from this collection the element at the given index. Returns the number of changes
    /// made.
    /// </summary>
    /// <param name="index"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection the first element with the given key. Returns the number of
    /// changes made.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection the last element with the given key. Returns the number of
    /// changes made.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection all the elements with the given key. Returns the number of
    /// changes made.
    /// </summary>
    /// <param name="key"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes from this collection all the elements that match the given predicate. Returns the
    ...
    /// <summary>
    /// Clears this collection. Returns the number of changes made.
    /// otherwise.
    /// </summary>
    /// <returns></returns>
    new int Clear();
