...
// ========================================================
public static class SketchOptionsEx
{
    /// <summary>
    ...
    public static string Sketch<T>([AllowNull] this T source, SketchOptions options)
    {
        ...
        switch (source)
        {
            ...
            case ConstructorInfo item: if (options.MethodOptions != null) return item.EasyName(options.MethodOptions); break;
        ...
        // Capturing...
        var xoptions = options.HeadOptions?.WithRecursive(
            useVariance: false,
        ...
        var head = options.HeadOptions == null ? null : type.EasyName(xoptions!);
        string? str;
