...
public record EasyMethodOptions
{
    ...
    public EasyMethodOptions(Mode mode)
    {
        ...
        {
            case Mode.Default:
                GenericListOptions = new EasyTypeOptions(EasyTypeOptions.Mode.Default);
                ParameterOptions = new EasyParameterOptions(EasyParameterOptions.Mode.Default);
                break;

            case Mode.Full:
                UseAccessibility = true;
                UseModifiers = true;
                ReturnTypeOptions = new EasyTypeOptions(EasyTypeOptions.Mode.Full);
                HostTypeOptions = new EasyTypeOptions(EasyTypeOptions.Mode.Full);
                UseTechName = true;
                GenericListOptions = new EasyTypeOptions(EasyTypeOptions.Mode.Full);
                ParameterOptions = new EasyParameterOptions(EasyParameterOptions.Mode.Full);
                break;
        }
    }
}
