...
// ========================================================
//[Enforced]
public static class Test_Sketch_Extensions
{
    const string NAMESPACE = "Yotei.Tools.Tests";
    const string CLASSNAME = nameof(Test_Sketch_Extensions);
    ...
    public static void Test_Null_Object()
    {
        ...
        var options = SketchOptions.False;
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeName = true } };
        name = source.Sketch(options); Assert.Equal("(Object) NULL", name);

        options = options with { EasyOptions = options.EasyOptions with { UseTypeNamespace = true } };
    ...
    public static void Test_Null_Others()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeName = true } };
        name = source.Sketch(options); Assert.Equal("(Nullable) NULL", name);

        options = options with { EasyOptions = options.EasyOptions with { UseTypeArguments = true } };
        name = source.Sketch(options); Assert.Equal("(Nullable<Int32>) NULL", name);

        options = options with { EasyOptions = options.EasyOptions with { UseTypeNamespace = true } };
        name = source.Sketch(options); Assert.Equal("(System.Nullable<System.Int32>) NULL", name);
    ...
    public static void Test_Double()
    {
        ...
        var options = SketchOptions.False with { Provider = CultureInfo.InvariantCulture };
    ...
    public static void Test_Enum_Simple()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeHost = true } };
        name = source.Sketch(options); Assert.Equal($"{CLASSNAME}.MyEnum.One", name);
    ...
    public static void Test_Enum_Flags()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeHost = true } };
        name = source.Sketch(options); Assert.Equal($"{CLASSNAME}.MyEnum.One | {CLASSNAME}.MyEnum.Two | {CLASSNAME}.MyEnum.Three", name);
    ...
    public static void Test_Dictionary()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeName = true } };
        name = source.Sketch(options); Assert.Equal("(Dictionary) {James = 50, Maria = 25}", name);
        ...
        Assert.Equal("(System.Collections.Generic.Dictionary<System.String, System.Int32>) {James = 50, Maria = 25}", name);
    ...
    public static void Test_Other_Collections()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeName = true } };
        name = source.Sketch(options); Assert.Equal("(List) [James, Maria]", name);
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeNamespace = true } };
        name = source.Sketch(options);
        Assert.Equal("(System.Collections.Generic.List<System.String>) [James, Maria]", name);
    ...
    public static void Test_Shape()
    {
        ...
        options = options with { EasyOptions = options.EasyOptions with { UseTypeName = true } };
        name = source.Sketch(options); Assert.Equal("(A) { Name = James }", name);

        options = options with { UsePrivateMembers = true };
        name = source.Sketch(options); Assert.Equal("(A) { Name = James, Age = 50 }", name);

        options = options with { UseStaticMembers = true };
        name = source.Sketch(options); Assert.Equal("(A) { Name = James, Age = 50, Org = MI6 }", name);
    ...
    //[Enforced]
    [Fact]
    public static void Test_Overriden_Base_ToString()
    {
        var source = new C();
