...
// ========================================================
//[Enforced]
public static class Test_EasyNameProperty
{
    static readonly string NAMESPACE = typeof(Test_EasyNameProperty).Namespace!;
    static readonly string TESTNAME = typeof(Test_EasyNameProperty).Name;
    ...
    public class Type2A<K, T> { public class Type2B<S> { public S? Name => default!; } }
