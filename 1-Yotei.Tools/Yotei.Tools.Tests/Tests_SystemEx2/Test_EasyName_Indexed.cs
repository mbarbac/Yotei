...
// ========================================================
//[Enforced]
public static class Test_EasyNameIndexed
{
    static readonly string NAMESPACE = typeof(Test_EasyNameIndexed).Namespace!;
    static readonly string TESTNAME = typeof(Test_EasyNameIndexed).Name;
    ...
    public static void Test0A_Standard()
    {
        ...
        options = DEFAULT with { UseReturnType = true };
    ...
    public class Type2A<K, T> { public class Type2B<S> { public K? this[T? one, S? two] => default!; } }
