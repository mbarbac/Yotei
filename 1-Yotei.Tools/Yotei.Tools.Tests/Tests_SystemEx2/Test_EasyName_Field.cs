...
// ========================================================
//[Enforced]
public static class Test_EasyNameField
{
    static readonly string NAMESPACE = typeof(Test_EasyNameField).Namespace!;
    static readonly string TESTNAME = typeof(Test_EasyNameField).Name;
