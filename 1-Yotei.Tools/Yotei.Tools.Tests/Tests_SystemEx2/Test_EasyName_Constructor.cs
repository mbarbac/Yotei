...
// ========================================================
//[Enforced]
public static class Test_EasyNameConstructor
{
    static readonly string NAMESPACE = typeof(Test_EasyNameConstructor).Namespace!;
    static readonly string TESTNAME = typeof(Test_EasyNameConstructor).Name;
    ...
    public static void Test0A_Standard()
    {
        ...
        options = EMPTY with { UseArgumentName = true };
    ...
    { public class Type1B<[IsNullable] S> { public Type1B(ref K one, in T two, out S three) { three = default!; } } }
