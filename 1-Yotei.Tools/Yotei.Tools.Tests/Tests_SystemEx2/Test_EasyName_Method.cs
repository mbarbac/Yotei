...
// ========================================================
//[Enforced]
public static class Test_EasyNameMethod
{
    static readonly string NAMESPACE = typeof(Test_EasyNameMethod).Namespace!;
    static readonly string TESTNAME = typeof(Test_EasyNameMethod).Name;
