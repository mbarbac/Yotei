...
public static class Test_EasyType
{
    ...
    //[Enforced]
    [Fact]
    public static void Test_Arrays_ValueType()
    {
        EasyTypeOptions options;
        string name;
        var source = typeof(int?[]);
    ...
    //[Enforced]
    [Fact]
    public static void Test_Arrays_ReferenceType_NullabilityLost()
    {
        EasyTypeOptions options;
        string name;
        var source = typeof(string?[]);
    ...
    //[Enforced]
    [Fact]
    public static void Test_Arrays_ReferenceType_NullabilityWrapped()
    {
        EasyTypeOptions options;
        string name;
        var source = typeof(IsNullable<string?>[]);
    ...
    interface IFace6a { void MyMethod1(int?[]? items); }

    // Arrays are themselves reference types, to the second '?' is lost by default
    //[Enforced]
    [Fact]
    public static void Test_ArrayArgument_Unwrapped()
    {
        EasyTypeOptions options;
        string name;
        var type = typeof(IFace6a);
    ...
    interface IFace6b { void MyMethod1(IsNullable<int?[]> items); }

    //[Enforced]
    [Fact]
    public static void Test_ArrayArgument_Wrapped()
    {
        EasyTypeOptions options;
        string name;
        var type = typeof(IFace6b);
        var method = type.GetMethod("MyMethod1")!;
        var source = method.GetParameters()[0].ParameterType;
