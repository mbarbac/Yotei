#pragma warning disable IDE0290, CA1822, IDE0044

namespace Yotei.Tools.Tests.EasyNames;

// ========================================================
//[Enforced]
public static class Test_Sketch
{
    static readonly string PREFIX = "Yotei.Tools.Tests.EasyNames.Test_Sketch";
    ...
    public static void Test_System_Type()
    {
        ...
        options = SketchOptions.Full;
        name = item.Sketch(options); Assert.Equal("public sealed class System.String", name);
    }
    ...
    public static void Test_Shape()
    {
        ...
        options = SketchOptions.Full;
        name = source.Sketch(options);
        Assert.Equal($"({PREFIX}.AX) {{ this, Name = (System.String) James }}",
            name);
    }
